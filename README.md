...
In-progress Rust port of the [CORE-MATH] project, which provides on-the-shelf open-source mathematical functions with correct rounding.
...
- [`core-math`]: safe Rust bindings to the [CORE-MATH] C library, which we test against
